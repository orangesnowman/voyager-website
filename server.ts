...
import { SYSTEM_INSTRUCTION, getSystemInstruction } from "./src/constants";
  ...
  wss.on("connection", async (clientWs, request) => {
    ...
    async function connectSession(modelName: string): Promise<any> {
      ...
      const languageInstruction = lang === "ES" 
        ...
        : "\n\nCRITICAL OVERRIDE - LANGUAGE CONFIGURATION: The user's preferred language is ENGLISH (EN). You MUST override any previous instructions and speak strictly, entirely, and exclusively in clear, natural American English as your primary, main conversational language. Respond, explain concepts, ask questions, teach, and converse 100% in clear American English. Do NOT default to Spanish dialogue.";
      ...
      const newSession = await ai.live.connect({
        ...
        config: {
          ...
          systemInstruction: getSystemInstruction(lang as 'EN' | 'ES') + languageInstruction + userIdentityInstruction,
